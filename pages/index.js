    ...
    <div className='bg-primary/60 h-full'>
      ...
      <div className='w-full h-full bg-gradient-to-r from-primary via-black/30 to-black/10'>
        ...
        xl:text-left h-full container mx-auto '>
          ...
          >
            ...
            Alias laudantium placeat a. Debitis est rerum reiciendis suscipit? 
      ...
      <div className='w-[1200px] h-full absolute right-0 bottom-0'>
        ...
        <motion.div 
          ...
          className='w-full h-full max-w-[735px] max-h-[678px] absolute -bottom-32 lg:bottom-0 lg:right-[8%]'
        >
          <Avatar />
        </motion.div>
      </div>
